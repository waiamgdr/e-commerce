...
try {
    const res=await axios.post("/postproduct",data,{headers:{
        token:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1Y2NkMzk5YTcxODRhOWJmMWIwMGM2NiIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcwODAxMjA0MywiZXhwIjoxNzA4NjE2ODQzfQ.WYXnEew6kluLKLrgb3MKE9jJFT1366ON2eCmJaQtids"
    }})
